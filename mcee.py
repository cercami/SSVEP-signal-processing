...
1. Basic operating functions:
    (1)Multi_linear regression
    (2)SNR in time domain
    (3) (Mean in time domain) Pearson Correlation Coefficient
    (4) Fisher Score
2. Three kinds of recursive algorithm to choose channels for optimization
    (1)Backward: backward_MCEE (Obsolete)
    (2)Forward: forward_MCEE (Obsolete)
...
#%% Stepwise SRCA
def stepwise_SRCA(chans, msnr, w, w_target, signal_data, data_target, method,
                  regression):
    '''
