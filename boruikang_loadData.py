...
LastEditTime: 2020-12-30 11:11:09
...
data_path = r'D:\SSVEP\dataset\preprocessed_data\cvep_8\wuqiaoyi\fir_50_90.mat'
...
for cv in range(6):
    ...
    # acc_etrca = mcee.eTRCA(train_data, test_data)
